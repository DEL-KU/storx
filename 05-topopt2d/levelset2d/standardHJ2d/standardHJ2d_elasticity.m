...
% the standard Hamilton-Jacobi (HJ) method for elasticity problems.         %
% It inherits from the standardHJ2d class.                                  %
%                                                                           %
...
classdef standardHJ2d_elasticity < standardHJ2d

    methods
        function obj = standardHJ2d_elasticity(solver,objective,constraints, mfgConstraints, ...
                nHolesX,nHolesY,r0, ...
            ...
            obj.m_history.objective = zeros(obj.m_maxNumIters,1);
            obj.m_history.change = zeros(obj.m_maxNumIters,1);
        ...
        function obj = evaluate(obj)
            % evaluate objective
            if (isa(obj.m_objective,'standardHJComplianceElasticity'))
                [obj.m_objective,obj.m_fx] = obj.m_objective.evaluate();
                obj.m_fx = mean(obj.m_fx);
            else
                disp('Only standardHJComplianceElasticity objective is available for this optimization!');
            end
