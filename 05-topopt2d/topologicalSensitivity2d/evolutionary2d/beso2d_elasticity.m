%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description:                                                              %
% This class implements a 2D bi-driectional evolutionary-based topology     % 
% optimization using elasticity problems. It inherits from the beso2d class %
%  and implements the methods necessary to solve the elasticity problem.    %
%                                                                           %
...
classdef beso2d_elasticity < beso2d

    methods
        function obj = beso2d_elasticity(solver,objective,constraints, mfgConstraints, ...
                volDecrement,exportGIF,testMode)

            % set default values
            if (nargin < 5),volDecrement = 0.01;end
            if (nargin < 6),exportGIF = false;end
            if (nargin < 7),testMode = false;end
            % construct
            obj = obj@beso2d(solver,objective,constraints, mfgConstraints, ...
