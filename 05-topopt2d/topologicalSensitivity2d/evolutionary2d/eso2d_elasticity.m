...
% elasticity problems. It inherits from the eso2d class and implements      %
% the methods necessary to solve the elasticity problem.                    %
%                                                                           %
...
classdef eso2d_elasticity < eso2d

    methods
        function obj = eso2d_elasticity(solver,objective,constraints, mfgConstraints, ...
