%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Discription:                                                              %
% This is a class for imposing the volume constraiont only on the           % 
% active design domain (subset of existing design domain) used in shape     % 
% and topology optimization (for example for fluid flow examples such as    % 
% the wind tunnel examples).                                                %
%                                                                           %
...
classdef activeVolume < functional
    ...
    methods
        %% CONSTRUCTOR
        function obj = activeVolume(solver, ub)
            ...
            obj.m_activeDomain = solver.m_activeDesignDomain;
            obj.m_numActiveElems = sum(obj.m_activeDomain(:));
        end
        ...
        function [obj,value] = evaluate(obj)
            activeDesign = obj.m_solver.m_design(obj.m_activeDomain==1);
            obj.m_fx = sum(activeDesign(:))/obj.m_numActiveElems;
        ...
        function [obj,grad] = gradient(obj)
            obj.m_dfdx = zeros(size(obj.m_solver.m_design));
            obj.m_dfdx(obj.m_activeDomain==1) = 1/obj.m_numActiveElems;
