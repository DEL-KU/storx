%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Discription:                                                              %
% This is a class for evaluating fluid drag and computing its               %
...
classdef densityDrag < functional
    ...
    methods
        %% CONSTRUCTOR
        function obj = densityDrag(solver, ub)
        ...
        function [obj,value] = evaluate(obj)
            ...
            for scenarioId = 1:obj.m_solver.m_numScenarios
                ...
                obj.m_fx(scenarioId) = sum(PHI_drag(dxv,dyv,muv, ...
        ...
        function [obj,grad] = gradient(obj)
            ...
            for scenarioId = 1:obj.m_solver.m_numScenarios
                U = obj.m_solver.m_sol(:,scenarioId);
                sR = dRESdg_drag(dxv,dyv,muv,rhov, ...
                    obj.m_solver.m_alpha(:)', ...
                ...
                dphidg = dPHIdg_drag(dxv,dyv,muv, ...
                    obj.m_solver.m_alpha(:)', ...
                    obj.m_solver.m_alphaGrad(:)', ...
                    U(obj.m_solver.m_edofMat'));
    ...
    methods(Access = 'private')
        function obj = solveAdjoint(obj)
            ...
            sR = [dPHIds_drag(dxv,dyv,muv,obj.m_solver.m_alpha(:)',U(obj.m_solver.m_edofMat')); zeros(4,obj.m_solver.m_numElems)];
