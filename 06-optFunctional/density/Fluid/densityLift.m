%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Discription:                                                              %
% This is a class for evaluating fluid lift and computing its               %
...
classdef densityLift < functional
    ...
    methods
        %% CONSTRUCTOR
        function obj = densityLift(solver, ub)
        ...
        function [obj,value] = evaluate(obj)
            ...
            for scenarioId = 1:obj.m_solver.m_numScenarios
                ...
                obj.m_fx(scenarioId) = -sum(PHI_lift(dxv,dyv,muv, ...
            ...
            if (obj.m_numEvaluations == 0)
                obj.m_fx0 = obj.m_fx;
                obj.m_scale = 1.0; % fx is negative
            end
        ...
        function [obj,grad] = gradient(obj)
            ...
            for scenarioId = 1:obj.m_solver.m_numScenarios
                U = obj.m_solver.m_sol(:,scenarioId);
                sR = dRESdg_lift(dxv,dyv,muv,rhov, ...
                    obj.m_solver.m_alpha(:)', ...
                ...
                dphidg = dPHIdg_lift(dxv,dyv,muv, ...
                    obj.m_solver.m_alpha(:)', ...
                    obj.m_solver.m_alphaGrad(:)', ...
                    U(obj.m_solver.m_edofMat'));
    ...
    methods(Access = 'private')
        function obj = solveAdjoint(obj)
            ...
            sR = [dPHIds_lift(dxv,dyv,muv,obj.m_solver.m_alpha(:)',U(obj.m_solver.m_edofMat')); zeros(4,obj.m_solver.m_numElems)];
