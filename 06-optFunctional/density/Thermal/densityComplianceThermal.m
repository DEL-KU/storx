%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Discription:                                                              %
% This is a class for evaluating thermal compliance and computing its       %
...
classdef densityComplianceThermal < functional
    ...
    methods
        %% CONSTRUCTOR
        function obj = densityComplianceThermal(solver, ub)
        ...
        function [obj,value] = evaluate(obj)
                ...
                for scenarioId = 1:obj.m_solver.m_numScenarios
                    for ely = 1:obj.m_solver.m_ny
                        for elx = 1:obj.m_solver.m_nx
                            ...
                            obj.m_cx(scenarioId) = obj.m_cx(scenarioId) + ...
                                Te'*KElem*Te;
                        end
                    end
                end
            ...
            if (obj.m_isConstraint)
                ...
                value = obj.m_fx/obj.m_fx0; % as objective
            end
                ...
                for scenarioId = 1:obj.m_solver.m_numScenarios
                    for ely = 1:obj.m_solver.m_ny
                        for elx = 1:obj.m_solver.m_nx
                            ...
                            obj.m_dfdx(ely,elx,scenarioId) = -interpCoeffGrad*Te'*KE*Te;
                        end
                    end
                end
            else
                interpCoeffGrad = obj.m_solver.getInterpolationCoefficientGrad(X);
                obj.m_dfdx = -interpCoeffGrad.*obj.m_ce;
            end

            if (obj.m_isConstraint)
                grad = obj.m_dfdx/obj.m_upperBound/obj.m_fx0;
            else
                grad = obj.m_dfdx/obj.m_fx0;
            end
        end
    end
end
