%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Discription:                                                              %
% This is a class for imposing symmetry constraints used in                 %
% shape and topology optimization (e.g., ESO).                              %
%                                                                           %
...
classdef  symmetry_tsf < mfgConstraints
    properties (GetAccess = 'public', SetAccess = 'protected')
        m_dir; % 0: x-dir, 1: y-dir
    end
    methods
        %% CONSTRUCTOR
        function obj = symmetry_tsf(solver,dir)
        ...
        function [filteredSensitivity] = filterSensitivity(obj, ~, sensField)
            ...
            if obj.m_dir == 0 % x-dir
                filteredSensitivity = max(sensField , fliplr(sensField));
            else % y-dir
                filteredSensitivity = max(sensField , flipud(sensField));
            end
        end
    end
end
