...
% % %%set bound
curvature(nonzero)= min(curvature(nonzero), max(1./ grid.dx)); % set the upper and lower bound of the curvature
curvature(nonzero) = max(curvature(nonzero), -max(1./ grid.dx));
